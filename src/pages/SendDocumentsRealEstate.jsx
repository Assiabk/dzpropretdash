...
const SendDocumentsRealEstate = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Submitting to Real Estate Registry:", form);
  };
      ...
      <main className="pt-40 px-4 md:px-10 bg-[#f8f9fa] min-h-screen">
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-md border border-[#e0e0e0]">
          <h1 className="text-2xl font-bold text-center text-[#006b4d] mb-6 border-b pb-2">
            Submit Contract to Real Estate Registry
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              ...
              >
                Submit to Real Estate Registry
              </button>
            </div>
          </form>
        </div>
...
export default SendDocumentsRealEstate;
